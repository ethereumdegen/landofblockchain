...
let localPlayer = {}
  ...
  socket.on('registerModel', function (data) {
  ...
  function registerModel(path)
  {
    var split_path = path.split('/assets/')
    var short_model_path = split_path[1];

    console.log('short model path')
    console.log(short_model_path)
